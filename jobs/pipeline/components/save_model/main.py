...
def main(
    ...
    with open(
        os.path.join(input_path, 'metadata.json'),
        'r',
        encoding='utf-8'
    ) as f:
    ...
    azureml.core.Model.register(
        ...
        model_path=input_path,                                             # Local file to upload and register as a model.
        ...
        properties={**metadata_dct['params'], **metadata_dct['metrics'], **metadata_dct['stats'], **metadata_dct['framework'], **{'random_state': metadata_dct['random_state']}},
